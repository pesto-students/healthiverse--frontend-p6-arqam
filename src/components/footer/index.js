...
export default function Footer() {
    return (
        <footer class="border border-top bg-white dark:bg-gray-800 w-full py-8">
            <div class="max-w-screen-xl px-4 mx-auto">
                ...
                <div class="text-center text-gray-500 dark:text-gray-200 pt-10 sm:pt-12 font-light flex items-center justify-center">
                    Created by <a class="underline ml-1 hover:text-gray-800 dark:text-gray-300 dark:hover:text-white transition-colors duration-200" href="#">Manik</a>
                </div>
            </div>
        </footer>
